                ...
                <div class="cart-item">
                    <div class="cart-item-content">
                        ...
                        <div class="cart-item-details">
                            <a href="../supplier/product.php?id=' . $row["productid"] . '" class="cart-item-link" style="text-decoration: none;">
        ...
        <div class="container">
            ...
            <div id="total-price" class="text-right mt-4">
                ...
                <?php if ($totalAmount > 0): ?>
                    <a href="../supplier/checkout.php" class="btn btn-success btn-lg ml-2">Check Out</a>
                <?php else: ?>
