...
<body>
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        $product_id = $_GET['id'];
        try {
            $sql = "SELECT productname, supplierprice, productdetails, image, supplierstock, productcategory FROM products WHERE productid = ?";
    ...
    <div class="product-section">
        <div class="container">
            ...
            <div id="productContainer" class="row">
                ...
                try {
                    $sql = "SELECT productid, productname, supplierprice, image 
                    FROM products 
                    WHERE supplierstock IS NOT NULL 
