...
$sql = "SELECT sectiontitle, sectioncontent FROM privacypolicy WHERE privacypolicyid = 1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        if (isset($_POST["privacyname"])) {
            $terms_name = $_POST["privacyname"];

            if ($_POST["privacyname"] !== $terms_title || $_POST["editorcontent"] !== $terms_content) {

                $sql = "UPDATE privacypolicy SET sectiontitle = ?, sectioncontent = ?";
                $params = array($terms_name, $_POST["editorcontent"]);

                $sql .= " WHERE privacypolicyid = 1";
...
<head>
    ...
    <title>Privacy Policy | System Maintenance</title>
            ...
            <ul class="side-menu">
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="active"><a href="../admin/privacypolicy.php">Privacy Policy</a></li>
    ...
    <main>
        <div class="box-section">
            <div class="head-title">
                <div class="left">
                    <h1 class="lefth">Privacy Policy</h1>
                </div>
            </div>
            <div class="container">
                                ...
                                <div id="form-container">
                                    <div class="input">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="privacyname" name="privacyname"
    ...
    if (!empty($message)) {
        if ($message === "success") {
            ...
            Swal.fire({
                ...
                text: 'You have successfully Updated the Privacy Policy.',
                icon: 'success',
                confirmButtonText: 'OK',
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '../admin/privacypolicy.php';
