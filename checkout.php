...
<body>
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    ...
                    if (isset($_SESSION['userid'])) {
                        ...
                        if ($verification_result && $verification_result->num_rows > 0) {
    ...
    document.getElementById("proceedButton").addEventListener("click", function() {
        ...
        if (paymentMethod === "PayPal") {
            ...
            var data =
                "userID=<?php echo $userID; ?>&productID=<?php echo $productID; ?>&quantity=<?php echo $quantity; ?>&totalPrice=<?php echo $totalPrice + $shippingFee - $discount_amount; ?>&totalProductPrice=<?php echo $totalPrice; ?>&shippingFee=<?php echo $shippingFee; ?>&status=Pending&paymentMethod=COD&addressID=<?php echo $shippingAddress['addressid']; ?>&discount_amount=<?php echo $discount_amount; ?>&transactionID=" +
                transactionID;
            xhr.send(data);
            <?php
                }
