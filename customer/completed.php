...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../public/css/customer/completed.css">
...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
        <a href="orderdetails.php?transactionid=<?php echo $row['transactionid']; ?>" style="text-decoration: none; color: inherit;">
            <div class="product-box">
                <div class="product-details">
                    <img src="../productimg/<?php echo $row['image']; ?>" alt="<?php echo $row['productname']; ?>" class="product-image">
                    <div class="product-info">
                        <div class="product-name"><?php echo $row['productname']; ?></div>
                        <div class="product-status"><span class="status <?php echo strtolower($row['status']); ?>"><?php echo $row['status']; ?></span></div>
    ...
    echo '<p class="orderdisplay">No Completed Orders</p>';
}
?>
<p class="margin"></p>
</div>
