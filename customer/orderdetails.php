                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="pending-section">
                            ...
                            ?>
                                <a href="../product.php?id=<?php echo $row['productid']; ?>" style="text-decoration: none; color: inherit;">
                                    <div class="product-box">
                                        <div class="product-details">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-status">Quantity: <span class="status <?php echo strtolower($row['quantity']); ?>"><?php echo $row['quantity']; ?></span></div>
...
<script>
    $(document).ready(function() {
        $(".printReceipt").click(function(e) {
            ...
            window.open('orderreceipt.php?transactionid=' + transactionid, '_blank', 'width=800,height=600');
        });
    });
</script>
